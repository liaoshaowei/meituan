 ...
 */
public class MyPtrPullToRefresh extends PtrFrameLayout{
    ...
    public MyPtrPullToRefresh(Context context) {
        super(context);
        initViews();
    }

    public MyPtrPullToRefresh(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews();
    }

    public MyPtrPullToRefresh(Context context, AttributeSet attrs, int defStyle) {
