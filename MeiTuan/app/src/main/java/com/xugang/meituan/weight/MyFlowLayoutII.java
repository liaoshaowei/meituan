 ...
 */
public class MyFlowLayoutII extends ViewGroup {
    ...
    public MyFlowLayoutII(Context context) {
        this(context, null);
    }

    public MyFlowLayoutII(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyFlowLayoutII(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mContext = context;
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.MyFlowLayout);
        lineSpacing = mTypedArray.getDimensionPixelSize(R.styleable.MyFlowLayout_lineSpacing, 0);
        mTypedArray.recycle();
    }
