...
public class MosaicLayout extends NestedScrollView {
	...
	private List<BlockPattern.BLOCK_PATTERN[]> patternsList = new ArrayList<BlockPattern.BLOCK_PATTERN[]>();
	...
	public void addPattern(BlockPattern.BLOCK_PATTERN patternsList[]) {
